...
public class ImageDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View dialogView = LayoutInflater.from(getActivity()).inflate(R.layout.image_fragment, null);
        final ImageView imageView = dialogView.findViewById(R.id.iv_image);
